...
$(document).ready(function() {
  ...
  myfunction(
    $(".container .menu .ulmenu4 li"),
  $(".container .ulmenu4 li a"),
  $(".container .content .menu4 .tab")
  );
  myfunction(
    $(".container .menu .ulmenu5 li"),
    $(".container .ulmenu5 li a"),
    $(".container .content .menu5 .tab")
  );
  myfunction(
    $(".container .menu .ulmenu6 li"),
  $(".container .ulmenu6 li a"),
  ...
  $(function() {
    ...
    $(".container .menu > ul li a").click(function() {
      $(".A2").text($(this).text());
    });
  });
});
